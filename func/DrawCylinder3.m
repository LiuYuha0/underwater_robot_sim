...
%      n          dim 1x1   the no. of elements on the cylinder circumference (more--> refined)
%      cyl_color  dim 3x1   color definition like 'r','b',[0.52 0.52 0.52]
%      closed     dim 1x1   ==1 for closed cylinder 
%                           ==0 for hollow open cylinder
%      lines      dim 1x1   ==1 displaying the line segments on the cylinder 
%                           ==0 for only surface
% return:
